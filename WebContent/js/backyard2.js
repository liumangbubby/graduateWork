							...
							.click(
									function() {
										if (array == null || array == "") {
											...
											document.getElementById("option").action = "/stuenroll/jsp/backyard/ExamAction!modify.action"; // 更换Form提交路径
											$('#type_1').val("modify");
											$('#ids').val(array);
											$('#option').submit(); // 提交删除表单
										}
...
function orderDaXuHao() {
	...
	if (daxuhao == "2"|| daxuhao == '7'|| daxuhao == '8') {
...
function orderRemark() {
	...
	if(order==7){
		document.getElementById("order").value=8;
	}
