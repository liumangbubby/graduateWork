	...
	<div class="body_div">
		<div class="div_1" style="position: relative;top:-80px;">
			...
			<fieldset class="set_1">
				...
				<div>
					<ol >
						<li class="li_1" style="font-size: 13px">使用本系统需先填写理论考试报名信息</li>
						...
						<li class="li_1" style="font-size: 13px;">报名表内均为必填项，要求报名者认真填写，保证填写信息正确无误、真实有效。</li>
						...
						<li class="li_1" style="font-size: 13px;">打印报名表后，考生必须在表格右下角的“签名”处进行亲笔签名，否则视为无效报名表。</li>
						<li class="li_1" style="font-size: 13px;">填表打印后，考生要按照转换培训页面的报名流程中的相关要求进行后续的报名材料准备和资格审核工作。</li>
						...
						<li class="li_1" style="font-size: 13px;">在填写或打印报名表期间，如出现显示错误、连接失败、无法提交、打印等系统功能问题，请拨打咨询电话：010-********、********。</li>
					</ol>
				</div>
			</fieldset>
			...
			<div class="div_3" align="center" style="position: relative;left: -20px;">
					<p>
						<input type="button" class="btn_1" value="我同意" onclick="toEnroll()" />
					</p>
			</div>
		</div>
	</div>
