...
<body class="body">
	...
	<div class="main_div" style="-moz-user-select: none; -webkit-user-select: none; ">
		...
		<div class="right_div">
			...
			<form name="form_1" method="post" action="/stuenroll/jsp/backyard/ManageAction!updateStuEnroll.action">
					...
					<table width="650" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td class="modify_td">
								...
								<select name="specialty_submit" class="modify_select chzn-select" tabindex="2">
								 ...
								 -->
								 ${enroll.specialty_submit}
								 <input type="hidden" name='specialty_submit' value="${enroll.specialty_submit}"/>
							</td>
						</tr>
						<tr>
							...
							<td class="modify_td">
								...
								<select name="place" class="modify_select chzn-select" tabindex="2">
									...
									<s:iterator id="obj" value="placeList">
										<option value="${obj.place}" ${enroll.place==obj.place?'selected=selected':'' }>${obj.place}</option>
									</s:iterator>
								</select>
								-->
								${enroll.place}
								<input type="hidden" name='place' value="${enroll.place}"/>
							</td>
						</tr>
						<!-- 
						<tr>
						...
						<tr>
							...
							<td class="modify_td">
								...
								-->
								${enroll.edu_school}
								<input type="hidden" name='edu_school' value="${enroll.edu_school}"/>
							</td>
						</tr>
						<tr>
							...
							<td class="modify_td">
								...
								-->
								${enroll.class_no}
								<input type="hidden" name='class_no' value="${enroll.class_no}"/>
							</td>
						</tr>
						<tr id='tr_stu_no'>
							...
							<td class="modify_td">
								...
								<input name="stu_no" id="stu_no" type="text" class="modify_in_1" value="${enroll.stu_no}" />
								 -->
								 ${enroll.stu_no}
								 <input type="hidden" name='stu_no' value="${enroll.stu_no}"/>
							</td>
						</tr>
						<tr>
							...
							<td class="modify_td">
								...
								<select name="join_state" class="modify_select chzn-select" tabindex="2">
								 ...
								 -->
								 ${enroll.join_state}
								 <input type="hidden" name='join_state' value="${enroll.join_state}"/>
