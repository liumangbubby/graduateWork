...
<div class="main_div">
  ...
  <div class="right_div spe_div">
    ...
    <hr />
    <form id="form_1" method="post" action="/stuenroll/jsp/backyard/EduSchoolAction!addRef.action">
    ...
    <input type="hidden" name="school" id="st" value="${param.eduId==null?eduId:param.eduId}"/>
        <div class="spe_div">
        <!-- 
      	<input type="button" value="全选" id="btn_1" class="op_btn" onclick="checkAll()"/>
      	 -->
      	<input type="button" value="保存" class="op_btn" onclick="submitForm()" />
