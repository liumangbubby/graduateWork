...
<body class="body">
	<form method="post" name="form_1"
		action="/stuenroll/jsp/backyard/LoginAction!login.action">
		<div class="login_div">
					...
					<tr>
						...
						<td><table width="100%" height="171" border="0"
								...
								<tr>
									...
									<td width="76%"><input name="username" type="text" value="${username }"
								...
								<tr>
									...
									<td><input name="password" type="password"
										class="login_in" id="password" value="${password }"/>
									</td>
								</tr>
								<tr>
