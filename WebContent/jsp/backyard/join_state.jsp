...
<div class="main_div">
  ...
  <div class="right_div spe_div">
    ...
    <table width="700" border="0" cellpadding="0" cellspacing="0" class="spe_table">
      ...
      <s:if test="joList.size>0">
      <s:iterator id="obj" value="joList" status="st">
      <tr style="background-color: ${st.index%2!=0?'#fcfcfc':'#E3FAE3'}">
      	<td height="32" align="center" class="cell">
        	<input name="joinStateId" id="stateId_${obj.id}" type="checkbox" value="${obj.id }" />
        </td>
        <td align="center" class="cell_num"><s:property value='#st.index+1'/></td>
        <td align="center" class="cell" name="stateName">${obj.state }</td>
        <td align="center" class="cell"><img src="../../pic/delete.png" width="22" onclick="delete_2('${obj.id }')"/></td>
      </tr>
      </s:iterator>
      </s:if>
      <s:if test="joList.size==0">
    ...
    <div class="spe_div">
      	<input type="button" value="全选" id="btn_1" class="op_btn" onclick="checkAll_2()"/>
      	<input type="button" value="删除" class="op_btn" onclick="deleteAll_2()"/>
      	<input type="button" value="添加" class="op_btn" onclick="insert_2()"/>
     </div>
  </div>
</div>
</body>
